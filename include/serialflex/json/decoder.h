...
private:
    ...
    static const GenericNode*
    getObjectItem(const GenericNode* parent, const char* name,
                  bool caseInsensitive);
    static const GenericNode*
    getChild(const GenericNode* parent);
    static const GenericNode*
    getNext(const GenericNode* parent);
